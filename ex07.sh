...
&& echo && ./ft_matrix.out mx 2,3 mxv "1,1;-1,1;-1,-1" "1,0,0" \
&& echo && ./ft_matrix.out mx 2,3 mxv "1,1;-1,1;-1,-1" "0,1,0" \
&& echo && ./ft_matrix.out mx 2,3 mxv "1,1;-1,1;-1,-1" "1,0,1" \
&& echo && ./ft_matrix.out mx 2,3 mxv "1,1;-1,1;-1,-1" "0,1,1" \
...
&& echo && ./ft_matrix.out nmp 3,4,2 mxm "1,0,0;0,2,0;0,0,3;1,1,1" "0,1;2,3;4,5;6,7" \
|| echo "Test Failed" \
;
