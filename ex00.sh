...
&& echo -e "\n	## Matrix Addition" \
&& echo && ./ft_matrix.out mx 2,2 add "1,2;3,4" "5,6;7,8" \
...
&& echo -e "\n	## Matrix Substraction" \
&& echo && ./ft_matrix.out mx 2,2 sub "1,2;3,4" "8,7;6,5" \
...
&& echo -e "\n	## Matrix Scaling" \
&& echo && ./ft_matrix.out mx 2,2 scl "1,2;3,4" "5" \
